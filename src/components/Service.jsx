  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <div className="inline-block mb-4 px-6 py-2 bg-sky-100/60 backdrop-blur-md rounded-full border border-sky-200/50">
              <span className="text-cyan-500 text-sm sm:text-base font-medium tracking-wide">PREMIUM SERVICES</span>
            </div>
      ...
      <div className="relative py-16 md:py-24 lg:py-32 overflow-hidden bg-white">
        <div className="absolute top-10 left-10 w-20 h-20 bg-sky-500/20 rounded-full"></div>
        <div className="absolute bottom-20 right-20 w-32 h-32 bg-sky-400/20 rounded-full"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block mb-6 sm:mb-8 px-8 py-3 sm:px-10 sm:py-4 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full backdrop-blur-md border border-gray-200 shadow-xl">
            <span className="text-base sm:text-lg font-bold tracking-wider text-cyan-500">LIMITED TIME OFFER</span>
          </div>
          ...
          <p className="text-xl sm:text-2xl text-cyan-400 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <div className="inline-block mb-4 px-6 py-2 bg-gray-100 backdrop-blur-md rounded-full border border-gray-200">
              <span className="text-cyan-500 text-sm sm:text-base font-medium tracking-wide">SHOWCASE</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 relative">
              <span className="relative z-10 text-sky-400 drop-shadow-2xl">
                PERFECT SOLUTIONS
      ...
      <div className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-white">
        <div className="absolute top-20 left-20 w-24 h-24 bg-sky-500/20 rounded-full"></div>
        <div className="absolute bottom-32 right-32 w-32 h-32 bg-sky-400/20 rounded-full"></div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-block mb-6 sm:mb-8 px-8 py-3 bg-gray-100 backdrop-blur-md rounded-full border border-gray-200">
            <span className="text-cyan-500 text-sm sm:text-base font-medium tracking-wide">EXCELLENCE</span>
          </div>
            ...
            <div className="group relative bg-gradient-to-br from-sky-600/80 to-sky-800/80 p-8 sm:p-10 md:p-12 rounded-3xl backdrop-blur-md border border-sky-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/50 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="mb-6 sm:mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-400">Professional Detailing</h3>
                </div>
                <p className="text-cyan-300/90 text-base sm:text-lg leading-relaxed">Our certified technicians use only premium products and techniques to restore your vehicle's finish.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-sky-600/80 to-sky-800/80 p-8 sm:p-10 md:p-12 rounded-3xl backdrop-blur-md border border-sky-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/50 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="mb-6 sm:mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-400">Paint Protection</h3>
                </div>
                <p className="text-cyan-300/90 text-base sm:text-lg leading-relaxed">Advanced ceramic coatings and paint protection films to preserve your vehicle's exterior.</p>
              </div>
            </div>
            ...
            <div className="group relative bg-gradient-to-br from-sky-600/80 to-sky-800/80 p-8 sm:p-10 md:p-12 rounded-3xl backdrop-blur-md border border-sky-400/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-sky-500/50 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="mb-6 sm:mb-8">
                  ...
                  <h3 className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-400">Premium Results</h3>
                </div>
                <p className="text-cyan-300/90 text-base sm:text-lg leading-relaxed">See the difference with our award-winning detailing services that leave your vehicle looking showroom-new.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-16 md:py-24 lg:py-32 relative bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <div className="inline-block mb-4 px-6 py-2 bg-gray-100 backdrop-blur-md rounded-full border border-gray-200">
              <span className="text-cyan-500 text-sm sm:text-base font-medium tracking-wide">PREMIUM QUALITY</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 relative">
              <span className="relative z-10 text-sky-400 drop-shadow-2xl">
            ...
            <p className="text-3xl sm:text-4xl md:text-5xl font-black text-sky-400 drop-shadow-2xl">
              THE BEST
            </p>
          </div>
      ...
      <div className="py-16 md:py-24 lg:py-32 relative bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-24">
            <div className="inline-block mb-4 px-6 py-2 bg-gray-100 backdrop-blur-md rounded-full border border-gray-200">
              <span className="text-cyan-500 text-sm sm:text-base font-medium tracking-wide">WHY CHOOSE US</span>
            </div>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-6 relative">
              <span className="relative z-10 text-sky-400 drop-shadow-2xl">
