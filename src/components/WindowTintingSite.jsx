  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-900/90 to-black/70 z-10"></div>
        <img 
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <div className="text-lg md:text-xl text-yellow-400 font-semibold mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-xl border-l-4 border-orange-500">
                  <div className="flex items-center mb-3">
                    <Sun className="text-orange-500 mr-3" size={24} />
                    <h4 className="font-bold text-gray-900">Superior Heat Rejection</h4>
                  </div>
                  <p className="text-gray-700">Our multilayer nano-ceramic particle technology blocks up to 98% of the infrared heat</p>
                </div>

                <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-6 rounded-xl border-l-4 border-purple-500">
                  <div className="flex items-center mb-3">
                    <Shield className="text-purple-500 mr-3" size={24} />
                    <h4 className="font-bold text-gray-900">UV Ray Protection</h4>
                  </div>
                  <p className="text-gray-700">XPEL PRIME XR PLUS provides SPF 1,000 protection that effectively blocks over 99% of harmful UV rays</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border-l-4 border-green-500">
                  <div className="flex items-center mb-3">
                    ...
                    <h4 className="font-bold text-gray-900">Greater Clarity</h4>
                  </div>
                  <p className="text-gray-700">Advanced nano construction in XPEL PRIMETM XR provides superior performance without reducing outbound visibility</p>
                </div>

                <div className="bg-gradient-to-br from-cyan-50 to-blue-50 p-6 rounded-xl border-l-4 border-cyan-500">
                  <div className="flex items-center mb-3">
                    <Wifi className="text-cyan-500 mr-3" size={24} />
                    <h4 className="font-bold text-gray-900">Crystal Clear Signal</h4>
                  </div>
                  <p className="text-gray-700">In the digital world, clear communication is key. PRIME XR PLUS construction will not interfere with radio, cellular, or Bluetooth signals</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="text-center">
              <div className="bg-gradient-to-br from-yellow-500 to-orange-500 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">1</div>
              ...
              <div className="bg-gray-800 p-6 rounded-lg">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-yellow-500 text-black px-3 py-2 rounded">
                    <span>PRIME CS</span>
                    <span>GOOD</span>
                  </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-blue-500 to-purple-500 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">2</div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-green-500 to-emerald-500 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">3</div>
          ...
          <div className="text-center">
            <div className="relative inline-block max-w-2xl mx-auto">
              ...
              <a 
                ...
                className="absolute inset-0 flex items-center justify-center bg-black/50 rounded-lg hover:bg-black/30 transition-all duration-300"
              >
                <div className="bg-red-600 w-20 h-20 rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-700 max-w-4xl mx-auto mb-16 font-semibold">
              ...
              <div key={key} className={`bg-white rounded-xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 ${selectedFilm === key ? 'ring-4 ring-blue-500' : ''}`}>
                <div className="p-6">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-gray-900 mb-2">{film.name}</h3>
                    <div className="mb-4">
                      <img 
                        src={film.logo} 
                        alt={`${film.name} Logo`}
                    ...
                    <p className="text-gray-600 font-semibold">{film.subtitle}</p>
                  </div>
                  ...
                  <div className={`text-center text-4xl font-black mb-6 ${
                    film.grade === 'GOOD' ? 'text-green-600' : 
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed mb-6">{film.description}</p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">TWO FRONTS ONLY:</h3>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">SIDES AND BACK:</h3>
              <div className="bg-gradient-to-br from-gray-50 to-blue-50 p-8 rounded-xl shadow-lg">
                <img 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <div className="bg-white p-8 rounded-xl shadow-xl inline-block">
              ...
              <h4 className="text-xl text-gray-700 mb-6">Window Tint Simulator</h4>
              <p className="text-gray-600 mb-6">Select a vehicle type and color. Then see how the different tint percentages, or as we call it Variable Light Transfers (VLT's), could look on the front, sides, and back of your vehicle.</p>
              <img 
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-gradient-to-br from-yellow-500 to-orange-500 w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                1
              </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-blue-500 to-purple-500 w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                2
              </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-green-500 to-emerald-500 w-20 h-20 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-6">
                3
              </div>
