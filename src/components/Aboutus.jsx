        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center justify-center">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">About Us</h2>
              ...
              <div className="space-y-4 sm:space-y-6 text-gray-700 text-sm sm:text-base md:text-lg leading-relaxed">
                <p className="text-base sm:text-lg md:text-xl">
                  ...
                  <span className="relative inline-block">
                    <span className="text-blue-600 font-bold text-lg sm:text-xl md:text-2xl bg-gradient-to-r from-blue-500 to-blue-700 bg-clip-text text-transparent animate-pulse shadow-lg">
                      #1 auto Detailing Service
                    </span>
                    <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-gradient-to-r from-blue-400 to-blue-600 animate-pulse"></span>
                  </span>{' '}
                  in Winnipeg.
                </p>
                ...
                <p className="text-sm sm:text-base md:text-lg">
                  ...
                  <span className="font-semibold text-gray-900 bg-yellow-100 px-2 py-1 rounded-md border-l-4 border-yellow-400 shadow-sm">
