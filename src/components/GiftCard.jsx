    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 p-4 flex items-center justify-center">
      <div className="w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-blue-600 to-pink-600 opacity-5"></div>
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-yellow-200 to-transparent rounded-full -translate-y-32 translate-x-32 opacity-30"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-blue-200 to-transparent rounded-full translate-y-24 -translate-x-24 opacity-30"></div>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-6 p-4 md:p-6 lg:p-8">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="relative">
                ...
                <Sparkles className="absolute -bottom-2 -right-2 text-pink-400 w-4 h-4 animate-pulse delay-300" />
                
                {/* Gift Card Design */}
                <div className="relative w-52 h-32 md:w-56 md:h-36 bg-gradient-to-br from-purple-600 via-blue-600 to-pink-600 rounded-2xl shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  <div className="absolute inset-2 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                    <div className="p-3 h-full flex flex-col justify-between">
                      ...
                      <div className="flex justify-center">
                        <img 
                          src={actionCarLogo} 
                          alt="Action Car Logo" 
                          className="h-6 md:h-8 w-auto filter drop-shadow-lg"
                        />
                      </div>
                      
                      {/* Gift Card Text */}
                      <div className="text-center">
                        <h3 className="text-white text-base md:text-lg font-bold mb-1">GIFT CARD</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <button
                    ...
                    disabled={quantity <= 1}
                    className="w-10 h-10 rounded-full bg-gray-200 hover:bg-gray-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center font-bold text-lg transition-colors duration-200"
                  >
                    -
                  </button>
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full bg-gray-200 hover:bg-gray-300 flex items-center justify-center font-bold text-lg transition-colors duration-200"
                  >
                    +
                  </button>
                </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-bold py-3 px-6 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
              >
