...
const GiftCard = () => {
  ...
  return (
    <div className="min-h-screen bg-snow p-4 flex items-center justify-center">
      <div className="w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-sky-200 to-transparent rounded-full -translate-y-32 translate-x-32 opacity-30"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-sky-100 to-transparent rounded-full translate-y-24 -translate-x-24 opacity-30"></div>
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-6 p-4 md:p-6 lg:p-8">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="relative">
                ...
                {/* Gift Card Design */}
                <div className="relative w-52 h-32 md:w-56 md:h-36 bg-white rounded-2xl shadow-xl transform rotate-3 hover:rotate-0 transition-transform duration-300 border-2 border-sky-200">
                  <div className="absolute inset-2 bg-white rounded-xl border border-gray-100">
                    <div className="p-3 h-full flex flex-col justify-between">
                      ...
                      <div className="text-center">
                        <h3 className="text-sky-400 text-base md:text-lg font-bold mb-1">GIFT CARD</h3>
                        <div className="text-sky-500 text-sm md:text-base font-semibold">
                          ${selectedAmount}.00
                        </div>
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center lg:text-left">
                <h1 className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-sky-400 to-sky-600 bg-clip-text text-transparent mb-3">
                  Perfect Gift Card
                </h1>
                <p className="text-sky-500 text-base leading-relaxed">
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-sky-500">Select Amount</h3>
              ...
              {/* Quantity Selection */}
              <div className="space-y-3">
                <h3 className="text-lg font-semibold text-sky-500">Quantity</h3>
...
{quantity}</span>
              ...
              {/* Total Price */}
              <div className="bg-gradient-to-r from-sky-50 to-white p-4 rounded-2xl border border-sky-100">
                <div className="flex justify-between items-center">
                  <span className="text-base text-sky-500">Total Price:</span>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-sky-400 to-sky-500 hover:from-sky-500 hover:to-sky-600 text-white font-bold py-3 px-6 rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-2"
              >
