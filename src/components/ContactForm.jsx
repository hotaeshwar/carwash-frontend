                ...
                <div className="container mx-auto relative z-10">
                    <div className="flex flex-col lg:flex-row items-start sm:items-center justify-between gap-6 sm:gap-8 lg:gap-16">
                        ...
                        <div className="w-full lg:w-1/2 text-left">
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-700 mb-4 sm:mb-6">
                            ...
                            <div className="mb-4 sm:mb-6">
                                ...
                                <a
                                    ...
                                    className="text-sm sm:text-base text-blue-700 hover:text-blue-500 transition duration-300"
                                >
                            ...
                            <div onSubmit={handleSubmit}>
                                <div className="mb-3 sm:mb-4">
                                    <input
                                        ...
                                        placeholder="Name"
                                        className="w-full p-2 sm:p-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300"
                                    />
                                </div>
                                ...
                                <div className="mb-4 sm:mb-6">
                                    ...
                                    <input
                                        ...
                                        name="photo"
                                        onChange={handleChange}
                                        className="w-full p-1 sm:p-2 text-sm sm:text-base border border-gray-300 rounded-lg file:mr-2 sm:file:mr-4 file:py-1 sm:file:py-2 file:px-2 sm:file:px-4 file:rounded-md file:border-0 file:bg-blue-700 file:text-white file:text-sm sm:file:text-base hover:file:bg-blue-600 transition duration-300"
                                    />
                                </div>
