    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-colors duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
            Book Your Service
          </button>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                ...
                <div className="text-gray-700">BBB Rating</div>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-2" />
                <div className="text-gray-700">MPI Accredited</div>
              </div>
              <div className="text-center p-6 bg-gray-50 rounded-lg">
                <Star className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
                <div className="text-gray-700">Premium Service</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-teal-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-white text-teal-700 rounded-full flex items-center justify-center font-bold text-xl mr-4">
                  1
                </div>
                <h3 className="text-2xl font-bold text-teal-100">Step 1:</h3>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-teal-100">Step 2:</h3>
              </div>
              <p className="text-white leading-relaxed">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold text-teal-100">Step 3:</h3>
              </div>
              <p className="text-white leading-relaxed">
            ...
            {/* Step 4 */}
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl md:col-span-2 lg:col-span-1">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-white text-teal-700 rounded-full flex items-center justify-center font-bold text-xl mr-4">
                  4
                </div>
                <h3 className="text-2xl font-bold text-teal-100">Step 4:</h3>
              </div>
              <p className="text-white leading-relaxed">
            ...
            {/* Step 5 */}
            <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl md:col-span-2 lg:col-span-2">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-white text-teal-700 rounded-full flex items-center justify-center font-bold text-xl mr-4">
                  5
                </div>
                <h3 className="text-2xl font-bold text-teal-100">Step 5:</h3>
              </div>
              <p className="text-white leading-relaxed">
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center justify-center bg-white border-2 border-red-500 rounded-full p-2 shadow-lg hover:shadow-xl transition-shadow duration-300 cursor-pointer">
              <img 
                src={googleIcon} 
                alt="Google Reviews" 
