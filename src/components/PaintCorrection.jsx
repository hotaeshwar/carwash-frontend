  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="animate-fade-in-up">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight">
              PAINT CORRECTION
              <span className="block text-3xl sm:text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-teal-400 to-blue-500 bg-clip-text text-transparent mt-2">
                POLISHING
              </span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-100 mb-8 max-w-3xl mx-auto font-medium bg-black/40 backdrop-blur-sm px-6 py-4 rounded-lg border border-white/20">
              Transform your vehicle's paint to showroom perfection with our professional correction services
            </p>
            <button className="bg-gradient-to-r from-teal-500 to-blue-600 hover:from-teal-600 hover:to-blue-700 text-white px-8 py-4 rounded-full text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-2xl">
              Get Started Today
            </button>
          </div>
        </div>
        ...
        {/* Floating Elements */}
        <div className="absolute top-20 left-10 w-20 h-20 bg-teal-500 rounded-full opacity-20 animate-pulse"></div>
        <div className="absolute bottom-20 right-10 w-16 h-16 bg-blue-500 rounded-full opacity-20 animate-pulse delay-1000"></div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto">
              <span className="text-teal-600 font-semibold">Eliminate imperfections</span> formed on your vehicle's paint surface back to a true proper shine.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16">
            {[
              ...
              return (
                <div key={index} className="group bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
      ...
      {/* Process Section */}
      <section className="py-16 sm:py-20 bg-gradient-to-br from-gray-900 to-gray-800 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
      ...
      <section className="py-16 sm:py-20 bg-gray-50 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mb-12">
            <div className="bg-gradient-to-r from-teal-600 to-blue-600 rounded-2xl p-8 sm:p-12 text-center text-white shadow-2xl transform hover:scale-105 transition-all duration-300">
              ...
              <button className="bg-white text-teal-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-colors duration-300 transform hover:scale-105">
                Book Now
              </button>
            </div>
          </div>
          ...
          <div className="text-center bg-white rounded-2xl p-8 sm:p-12 shadow-xl">
            <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Our Packages</h3>
            <p className="text-xl sm:text-2xl text-teal-600 font-semibold mb-6">
              Pick your vehicle and Detailing Package
            </p>
            <p className="text-gray-600 text-lg">
              Please note for all the services <span className="text-teal-600 font-semibold">scheduled</span> later in the <span className="text-teal-600 font-semibold">afternoon</span>, the vehicle pickup will be the <span className="text-teal-600 font-semibold">next day</span>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-gradient-to-r from-teal-600 to-blue-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-teal-600 transition-all duration-300 transform hover:scale-105">
              View Gallery
            </button>
          </div>
        </div>
