    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4 max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent drop-shadow-2xl">
            PAINT PROTECTION FILM
          </h1>
          <p className="text-xl md:text-2xl mb-4 text-gray-200">Say Goodbye To...</p>
          <div className="h-12 md:h-16 mb-8">
            <h2 className="text-3xl md:text-5xl font-bold text-cyan-400 animate-pulse">
              {runningTexts[currentText]}
            </h2>
          </div>
          <p className="text-lg md:text-xl mb-8 text-gray-300">Before It Ever Happens</p>
          <div className="h-1 w-32 bg-gradient-to-r from-cyan-400 to-purple-400 mx-auto rounded-full mb-8"></div>
          <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-2xl">
            Get A Free Quote
          </button>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-b from-gray-900 to-slate-800">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-gradient-to-b from-gray-700 to-gray-800 p-6 rounded-xl text-center hover:transform hover:scale-105 transition-all duration-300 shadow-xl">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white">
                  {benefit.icon}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-bold text-white mb-4">INCREASE AND RETAIN RESELL VALUE</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold text-white mb-4">HIGHEST LEVEL OF PROTECTION</h3>
                <p className="text-gray-300 leading-relaxed">
          ...
          {/* XPEL Section */}
          <div className="bg-gradient-to-r from-gray-800 to-slate-700 rounded-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="mb-8">
                  <img 
                    ...
                    className="h-16 mb-4"
                  />
                  <h3 className="text-3xl font-bold text-white mb-4">Why XPEL?</h3>
              ...
              <div className="space-y-6">
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Self-Healing Topcoat</h4>
                  <p className="text-gray-300">Constructed from a polyurethane, ULTIMATE PLUS will self-heal light scratches & swirls</p>
                </div>
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Non-Yellowing</h4>
                  <p className="text-gray-300">Proprietary film will not yellow from UV exposure, staying nearly invisible</p>
                </div>
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Stain Resistant</h4>
                  <p className="text-gray-300">ULTIMATE PLUS is stain resistant & will maintain clarity against contaminants</p>
                </div>
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Prevents Wear & Tear</h4>
                  <p className="text-gray-300">Stop rock chips, nicks & scratches in the paint, and keep your vehicle looking new</p>
                </div>
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Edge Seal Technology</h4>
                  <p className="text-gray-300">Lifting & delamination are a thing of the past as our Edge Seal Technology ensures film stays stuck & keeps surfaces protected</p>
                </div>
                <div className="bg-gray-900/50 p-6 rounded-xl">
                  <h4 className="text-xl font-bold text-cyan-400 mb-3">Warranty and Durability</h4>
                  <p className="text-gray-300">Superior Impact Protection and Industry Leading 10 Year Warranty</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8">Click below to learn more</p>
          <img 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {packages.map((pkg, index) => (
              <div key={index} className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-2xl p-6 hover:transform hover:scale-105 transition-all duration-300 shadow-2xl border border-gray-700">
                <div className="text-center mb-6">
                  ...
                  />
                  <h3 className="text-xl font-bold text-cyan-400 mb-2">{pkg.name}</h3>
                  <div className="text-2xl font-bold text-white mb-2">Starting at {pkg.price}</div>
                  <div className="text-gray-300">Service Time {pkg.serviceTime}</div>
                </div>
                
                <div className="space-y-3 mb-6">
                  <h4 className="text-cyan-400 font-semibold">WHAT IS INCLUDED:</h4>
                ...
                <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
                  Get Quote
                </button>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300 mb-8">
                ...
                <p className="text-xl font-semibold text-cyan-400">We Provide The Peace of mind you and your vehicle deserve</p>
              </div>
      ...
      <section className="py-16 bg-gray-900">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8">
            ...
            products. Our meticulous attention to detail here at <span className="text-cyan-400 font-bold">ACTION CAR DETAILING</span> is sure to keep your mind at ease. You can rest 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {faqData.map((faq, index) => (
              <div key={index} className="bg-gradient-to-r from-gray-800 to-slate-700 rounded-xl overflow-hidden shadow-xl">
                <button
                  onClick={() => toggleFAQ(index)}
                  className="w-full p-6 text-left flex justify-between items-center hover:bg-gray-700/50 transition-colors duration-300"
                >
                ...
                {openFAQ === index && (
                  <div className="px-6 pb-6 bg-gray-900/50">
                    ...
                    <button className="mt-6 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300">
                      GET MY QUOTE
                    </button>
                  </div>
                )}
